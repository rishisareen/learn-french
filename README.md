...
## Why this target (the strategic math)

- At 47, CRS age points are **zero**, so general Express Entry draws (~520–550 cutoffs) are out of reach.
- **French-category draws** invite at far lower cutoffs — recent 2026 draws: **CRS 382 (Aug 19)** and **399 (Jul 22)**, each with 5,000 invitations, trend downward.
- NCLC 7 French + CLB 5+ English also earns **50 bonus CRS points**.
- NCLC 7 ≈ CEFR B2. The *weakest* skill counts — all four must clear 7. Speaking and writing are the usual failure points.
- Insurance: French also unlocks streams like Ontario's French-Speaking Skilled Worker PNP.

**Verify early (separate from language work):** FSW 67-point eligibility grid (age gives 0 points at 47 — confirm education + experience + language clears 67), ECA, IELTS/CELPIP for English.

## Timeframe

English speaker → B2 French ≈ **600–700 effective hours**. At a sustainable **12–14 hrs/week**: **15–18 months to test day**. Results are valid 2 years, so a strong late attempt beats a weak early one.
...
- [French Express Entry draws 2026 — cutoffs](https://workvisa.guide/blog/french-express-entry-draws-2026) · [Aug 19, 2026 draw (CRS 382)](https://immigrationnewscanada.ca/latest-express-entry-draw-august-19-2026/) · [Jul 22, 2026 draw (CRS 399)](https://immigration.ca/canada-invites-5000-french-speaking-candidates-express-entry-crs-399-july-22-2026/)
- [French category requirements](https://moving2canada.com/immigration/express-entry/french-category-based-express-entry-draws/) · [AF Delhi TCF Canada](https://afdelhi.org/tcf-exams/) · [TEF/TCF in India — fees & centres](https://www.languagenext.com/blog/tef-tcf-exam-dates-fees-centers-india/)
- [Ferriss DiSSS framework](https://modelthinkers.com/mental-model/disss-learning) · [Deconstruction method](https://blog.thelinguist.com/tim-ferriss-deconstructing-method/) · [Pimsleur French review](https://copycatcafe.com/blog/pimsleur)
